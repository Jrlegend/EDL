...
--Enumeration (keypressed possui número limitado de possibilidades)
...
function love.draw ()
    ...
    --trabalho-06   placar = {325,250,0, 1.2, 1.2}
		love.graphics.print("Pontuação: "..val, placar[0], placar[1], placar[2], placar[3], placar[4])
    love.graphics.print("GAME OVER!", placar[0]+5, placar[1]+50,placar[2], placar[3], placar[4])
    --utilização da variavel placar (TUPLA) no jogo.
